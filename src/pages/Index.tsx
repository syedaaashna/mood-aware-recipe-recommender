...
const Index = () => {
  ...
  return (
    ...
    >
      {/* Hero Section */}
      <div className="w-full flex flex-col items-center px-2 pb-16">
            ...
            <div className="w-full flex justify-center pt-6 pb-8">
              <div className="bg-gradient-to-br from-[#9b87f5] via-[#D3E4FD] to-[#f1f1f1] rounded-3xl shadow-xl p-8 flex flex-col items-center max-w-2xl w-full transition-all duration-500 hover:scale-105 hover:shadow-2xl glass-card">
                ...
                <h3 className="text-3xl font-bold mb-2 text-gray-800">
                  Select a mood to find your perfect recipe
                </h3>
                <div className="text-gray-700 mb-2 text-lg">
                  Our AI will help you discover dishes that match your current feeling. <br/>
                  <span className="text-purple-600 font-semibold">Choose a mood and let's cook!</span>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="max-w-6xl mx-auto p-4">
          {(recipes.length === 0) ? (
            <div className="text-gray-500 text-lg text-center py-16">
              No recipes found for this mood. Try another mood!
            </div>
          ) : (
